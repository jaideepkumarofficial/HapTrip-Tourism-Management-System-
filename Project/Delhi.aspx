<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delhi.aspx.cs" Inherits="Project.Delhi" %>
...
<body style="width: 1342px; height: 1302px; margin-left: 0px; margin-top: 0px; margin-bottom: 0px">
    <form id="form1" runat="server">
   
         <ul>
             <br/>
                <li style="font-family: 'Itim', cursive; font-size:30px; width: 150px; height: 60px;"><a class="active" text-decoration: none; href="http://localhost:31927/Home.aspx">HapTrip</a></li>
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="Delhi/d1.jpg" alt="Delhi" style="width: 1343px">
    </div>

    <div class="item">
      <img src="Delhi/d2.jpg" alt="Delhi">
    </div>

    <div class="item">
      <img src="Delhi/d3.jpg" alt="Delhi">
    </div>
      
    <div class="item">
      <img src="Delhi/d4.jpg" alt="Delhi">
    </div>

    <div class="item">
      <img src="Delhi/d5.jpg" alt="Delhi">
    </div>
  </div>
...
<table class="style61">
        <tr>
            <td>
                <h1 style="color:#006699">“Certainly Delhi is unimaginably antique, and age is a 
                    metaphysic, I suppose. Illustrations of mortality are inescapable there, and do 
                    give the place a sort of nagging symbolism. Tombs of emperors stand beside 
                    traffic junctions, forgotten fortresses command suburbs, the titles of lost 
                    dynasties are woven into the vernacular, if only as street names.“</h1>
