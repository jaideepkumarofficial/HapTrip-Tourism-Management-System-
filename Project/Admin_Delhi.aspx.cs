...
namespace Project
{
    public partial class Admin_Delhi : System.Web.UI.Page
    {
        ...
        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            ...
            da.UpdateCommand = new SqlCommand("Update [Delhi] Set Package_Name=@Package_Name, Night=@Night, Price=@Price, Inclusions=@Inclusions, Description=@Description Where Package_Id=@Package_Id", con);
