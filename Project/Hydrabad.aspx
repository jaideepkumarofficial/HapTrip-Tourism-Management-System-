<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hydrabad.aspx.cs" Inherits="Project.Hydrabad" %>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="hydrabad/1.jpg" alt="1">
    </div>

    <div class="item">
      <img src="hydrabad/2.jpg" alt="2">
    </div>

    <div class="item">
      <img src="hydrabad/3.jpg" alt="3">
    </div>
      
    <div class="item">
      <img src="hydrabad/4.jpg" alt="4">
    </div>

    <div class="item">
      <img src="hydrabad/5.jpg" alt="5">
    </div>
  </div>
    ...
    <table align="center" class="style62" style="border: medium groove #006699">
        ...
        <tr>
            <td style="text-align: center" class="style68">
                Package Id :</td>
            <td style="text-align: center" class="style68">
                <asp:DropDownList ID="DDL1" runat="server" AutoPostBack="True" Height="22px" 
                    onselectedindexchanged="DDL1_SelectedIndexChanged1" Width="126px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
...
<div class="footer" width="100%">
        <table class="style14">
            <tr>
                <td class="style69" style="font-weight: 500;">
                    Explore</td>
