<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Hydrabad.aspx.cs" Inherits="Project.Admin_Hydrabad" %>
...
<body style="width: 1349px; height: 1253px; margin-left: 0px; margin-top: 11px; margin-bottom: 0px">
  ...
  <li style="float:right; width: 101px; text-decoration: none;"><a href="http://localhost:31927/Home.aspx">Home</a></li>
    ...
    <h2 style="color:#006699">Hydrabad, The Essence of Incredible India.</h2>
