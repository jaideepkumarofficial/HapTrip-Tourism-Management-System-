...
namespace Project
{
    public partial class Mumbai : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select Package_Id from Mumbai order by Package_Id";
        ...
        {
            string sql = "select Package_Name,Night,Price,Inclusions,Description from Mumbai where Package_Id=" + DDL1.SelectedItem.ToString() + "";
            SqlDataAdapter da = new SqlDataAdapter(sql, con);
            DataSet ds = new DataSet();
            da.Fill(ds, "s");
            DataTable dt = ds.Tables["s"];
