<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Bangalore.aspx.cs" Inherits="Project.Admin_Bangalore" %>
...
<body style="width: 1349px; height: 1248px; margin-left: 0px; margin-top: 11px; margin-bottom: 0px">
...
<br />
    ...
    <table class="style61" align="center" frame="border" 
        ...
        <tr>
            ...
            <td class="style15">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="TB2" ErrorMessage="Please Fill *" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style66">
        ...
        <tr>
            <td style="text-align: center" class="style63" colspan="2">
...
<div class="footer" width="100%">
        <table class="style14">
            <tr>
                <td class="style67" style="font-weight: 500;">
                    Explore</td>
