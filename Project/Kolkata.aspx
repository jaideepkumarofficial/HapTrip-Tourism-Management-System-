<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kolkata.aspx.cs" Inherits="Project.Kolkata" %>
...
<body style="width: 1349px; height: 1377px; margin-left: 0px; margin-top: 0px; margin-bottom: 0px">
    <form id="form1" runat="server">
    <ul>
             <br/>
                <li style="font-family: 'Itim', cursive; font-size:30px; width: 153px; text-decoration: none;"><a class="active" href="http://localhost:31927/Home.aspx">HapTrip </a></li>
...
<br />
    ...
    <table class="style61">
        <tr>
            <td>
                <h1 style="color:#006699">“Take only memories, leave only footprints.“</h1>
