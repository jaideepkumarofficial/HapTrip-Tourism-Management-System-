<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bangalore.aspx.cs" Inherits="Project.Bangalore" %>
...
<body style="width: 1349px; height: 1463px; margin-left: 0px; margin-top: 11px; margin-bottom: 0px">
  ...
  <li style="float:right; width: 101px; text-decoration: none;"><a href="http://localhost:31927/Front.aspx">Home</a></li>

</ul>
    <h2 style="color:#006699">Bangalore, The Silicon Valley of India.</h2>
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="Bangalore/b1.jpg" alt="Bangalore">
    </div>

    <div class="item">
      <img src="Bangalore/b2.jpg" alt="Bangalore">
    </div>

    <div class="item">
      <img src="Bangalore/b3.jpg" alt="Bangalore">
    </div>
      
    <div class="item">
      <img src="Bangalore/b4.jpg" alt="Bangalore">
    </div>

    <div class="item">
      <img src="Bangalore/b5.jpg" alt="Bangalore">
    </div>
  </div>
...
<br />
    <table class="style61">
        <tr>
            <td>
                <h1 style="color:#006699">“You will like to love it so much. The love for the weather in Bangalore, the pleasant climate,<br /> the cool breeze, the intermittent drizzles is such an awesome.“</h1>
    ...
    <table align="center" class="style62" style="border: medium groove #006699">
        ...
        <tr>
            <td style="text-align: center" class="style68">
                Package Id :</td>
            <td style="text-align: center" class="style68">
                <asp:DropDownList ID="DDL1" runat="server" AutoPostBack="True" Height="21px" 
                    onselectedindexchanged="DDL1_SelectedIndexChanged" Width="159px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
